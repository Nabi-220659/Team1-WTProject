...
try {
    ...
    $db->partner_analytics->insertOne([
        ...
        "ai_insights" => [
            [
                "icon" => "📈",
                "title" => "Yield Increasing Trend",
                "body" => "Your portfolio yield has grown 3.2% over 6 months. Business loans are the key driver at 13.8% avg yield.",
                "color_bg" => "rgba(16, 185, 129, 0.06)",
                "color_border" => "rgba(16, 185, 129, 0.15)"
            ],
            [
                "icon" => "⚠️",
                "title" => "Concentration Risk Alert",
                "body" => "Personal loans make up 43% of AUM. Consider diversifying into home loans to reduce single-segment exposure.",
                "color_bg" => "rgba(245, 166, 35, 0.06)",
                "color_border" => "rgba(245, 166, 35, 0.15)"
            ],
            [
                "icon" => "🎯",
                "title" => "Opportunity Identified",
                "body" => "12 pre-approved borrowers with 750+ CIBIL are awaiting funding. Estimated yield: 11.2% p.a.",
                "color_bg" => "rgba(59, 130, 246, 0.06)",
                "color_border" => "rgba(59, 130, 246, 0.15)"
            ]
        ]
    ]);
    ...
    // --- 5. SEED RISK INSIGHTS ---
    $db->partner_risk_insights->deleteMany([]);
